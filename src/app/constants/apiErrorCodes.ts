export const ERROR_CODES = {
  ...
  AUTH_UNAUTHORIZED: 'AUTH_UNAUTHORIZED', // Añadido para mapeo
  AUTH_FORBIDDEN: 'AUTH_FORBIDDEN',       // Añadido para mapeo
  ...
  // Conflict
  CONFLICT_ERROR: 'CONFLICT_ERROR', // Añadido para mapeo
