import { z } from 'zod';
import { baseListQuerySchema, BaseListQueryDto } from '../../../app/types/api.types';
...
export const updateSubCategoryDtoSchemaWithOptionalPhoto = updateSubCategoryDtoSchema.extend({
...
export type UpdateSubCategoryDto = z.infer<typeof updateSubCategoryDtoSchemaWithOptionalPhoto>;
...
// Definir el tipo manualmente para asegurar opcionalidad correcta en TypeScript
