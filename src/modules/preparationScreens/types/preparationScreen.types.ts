...
export const CreatePreparationScreenSchema = z.object({
  ...
  description: z.string().max(255, 'La descripción no puede exceder los 255 caracteres').nullable().optional(),
...
export type CreatePreparationScreenDto = z.infer<typeof CreatePreparationScreenSchema>;
export type UpdatePreparationScreenDto = z.infer<typeof UpdatePreparationScreenSchema>;
...
export type FindAllPreparationScreensDto = z.infer<typeof FindAllPreparationScreensSchema>;