...
import { useThemeStore, useSystemThemeDetector } from './src/app/store/themeStore'; // Importación original
...
export default function App() {
  ...
  // Llama al hook para detectar y actualizar el tema del sistema en el store ANTES de leer el tema
  useSystemThemeDetector();

  // Leer activeTheme DESPUÉS de llamar al detector
  const activeTheme = useThemeStore((state) => state.activeTheme);

  // Mostrar pantalla de carga mientras se inicializa la autenticación
  if (isInitializingAuth) {
    return (
      // Usar un View simple para la carga
